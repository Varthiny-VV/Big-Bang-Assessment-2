    ...
    return <div>
      <div class="container-fluid bg-container">
            ...
            <div class="col-md-3 text-end">
                <button type="button" class="btn btn-outline-dark me-2" onClick={handleLogin}>Login</button>
                <button type="button" class="btn btn-dropdown-toggle" data-bs-toggle="dropdown">Sign-up</button>
                <ul className="dropdown-menu">
          <li>
            <button className="dropdown-item" onClick={handleSignupPatient}>
              Patient
            </button>
          </li>
          <li>
            <button className="dropdown-item" onClick={handleSignupDoctor}>
              Doctor
            </button>
          </li>
        </ul>
            ...
            <div class="container mb-2 pb-2" >
                <div id="carouselExampleCaptions" class="carousel slide d-flex">
                    ...
                    <div class="carousel-item active">
                        <img src={process.env.PUBLIC_URL + '/images/slide_1.jpg'} class="d-block w-100" alt=""></img>
                    ...
                    <div class="carousel-item">
                        <img src={process.env.PUBLIC_URL + '/images/slide_2.jpg'} class="d-block w-100" alt=""></img>
                        <div class="carousel-caption d-none d-md-block">
                    ...
                    <div class="carousel-item">
                        <img src={process.env.PUBLIC_URL + '/images/slide_3.jpg'} class="d-block w-100" alt="a image representing unity"></img>
                        <div class="carousel-caption d-none d-md-block">
            ...
            <div class="container col-xxl-8 px-4 py-5">
                <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                  <div class="col-10 col-sm-8 col-lg-6">
                    <img src={process.env.PUBLIC_URL + '/images/doctors.jpg'} class="d-block mx-lg-auto img-fluid" alt="VV Hospital Doctors" width="700" height="500" loading="lazy"></img>
                  </div>
                  <div class="col-lg-6">
              ...
              <div class="p-5 text-center bg-body-tertiary rounded-3">
                ...
                <img class="reviewers pt-1 pb-2" src={process.env.PUBLIC_URL + '/images/david.jpg'} alt="david image" height="90"></img>
                <p class="lead">
            ...
            <div class="p-5 text-center bg-body-tertiary rounded-3">
                ...
                <img class="reviewers pt-1 pb-2" src={process.env.PUBLIC_URL + '/images/sarah.jpg'} alt="sarah image" height="90"></img>
                <p class="lead">
            ...
            <div class="container-fluid">
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                  <p class="col-md-3 mb-0 text-body-secondary">© 2023 VV Healthcare. All Rights Reserved.</p>
                  ...
                  <a href="/" class="col-md-3 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
                    <img src={process.env.PUBLIC_URL + '/images/heart_logo.jpg'} alt="Hospital logo" width="45" height="45"></img>
                  </a>
